...
var Cluster = (function (_super) {
    ...
    Cluster.prototype.render = function () {
        var _this = this;
        var _a = this.props, ClusterMarkerFactory = _a.ClusterMarkerFactory, style = _a.style, className = _a.className;
        var clusterPoints = this.state.clusterPoints;
        return (React.createElement("div", { style: style, className: className, onClick: this.props.zoomOnClick ? this.zoomToClusterBounds : undefined }, clusterPoints.map(function (feature) {
